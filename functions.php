...
$sage_includes = [
    ...
    'src/filters.php',
    'src/admin.php',
    'models/taxonomy/guide.php',
    'models/taxonomy/attitude.php',
    'models/taxonomy/branch.php',
    'models/taxonomy/industry.php',
    'models/taxonomy/question.php',
    'models/taxonomy/resource.php',
    'models/taxonomy/role.php',
    'models/post-type/tool.php',
    'models/post-type/methodology.php',
    'models/post-type/mindset.php',
    'models/post-type/source.php'
];
